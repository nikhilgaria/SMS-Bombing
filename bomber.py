...
def check_for_updates():
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("file is up-to-date")
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("Bomber was created by Nikhil")
...
__CONTRIBUTORS__ = ['Nikhil', 'Vardhan01']
...
description = """SMS - Your Friendly Spammer Application
